...
interface RTCVideoViewProps extends ViewProps {
  ...
  /**
   * Android-only renderer implementation.
   * - surface: default SurfaceViewRenderer, fastest for regular video.
   * - texture: TextureView renderer, useful when the view needs clipping,
   *   rounded masks, opacity, transforms, or normal sibling composition.
   *
